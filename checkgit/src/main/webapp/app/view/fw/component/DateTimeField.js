 ...
 */
Ext.define('Checkgit.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Checkgit.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Checkgit.view.fw.component.DateTimePicker(o);
    },
