...
Ext
		.define(
				'Checkgit.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Checkgit.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
