 ...
 * 
 */
Ext.define('Checkgit.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Checkgit.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
