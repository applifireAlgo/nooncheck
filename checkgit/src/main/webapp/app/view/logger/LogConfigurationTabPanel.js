...
Ext
		.define(
				'Checkgit.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Checkgit.view.logger.tabs.details.DetailsTab',
							'Checkgit.view.logger.tabs.fileconnector.FileConnectorTab',
							'Checkgit.view.logger.tabs.dbconnector.DBConnectorTab',
							'Checkgit.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Checkgit.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Checkgit.view.logger.LogConfigurationTabPanelController',
