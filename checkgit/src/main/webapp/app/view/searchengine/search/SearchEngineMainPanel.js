Ext.define('Checkgit.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Checkgit.view.searchengine.search.NorthPanel', 'Checkgit.view.searchengine.search.SearchResult','Checkgit.view.searchengine.search.SearchEngineMainPanelController'],
