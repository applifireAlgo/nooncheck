Ext
		.define(
				'Checkgit.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Checkgit.view.searchengine.search.SearchEngineMainPanelController','Checkgit.view.searchengine.search.PanelHeaderField' ,'Checkgit.view.searchengine.search.ReportGridView','Checkgit.view.searchengine.search.ReportChartView','Checkgit.view.searchengine.search.documentView','Checkgit.view.searchengine.search.DouMeanView','Checkgit.view.googlemaps.map.MapPanel'],
