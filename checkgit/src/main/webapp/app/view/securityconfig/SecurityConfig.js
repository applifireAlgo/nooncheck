 ...
 * 
 */
Ext.define('Checkgit.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Checkgit.view.securityconfig.SecurityConfigController',
			'Checkgit.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
