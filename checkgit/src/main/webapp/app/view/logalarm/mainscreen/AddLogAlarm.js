 ...
 * 
 */
Ext.define('Checkgit.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Checkgit.view.logalarm.mainscreen.AddLogAlarmController',
			'Checkgit.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Checkgit.view.logalarm.mainscreen.AppAlarmPanel',
