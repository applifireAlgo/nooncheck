 ...
 * 
 */
Ext.define('Checkgit.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Checkgit.view.logalarm.LogAlarmMainViewController',
			'Checkgit.view.logalarm.tree.LogAlarmTreePanel',
			'Checkgit.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
