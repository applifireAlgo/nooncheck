 ...
 * 
 */
Ext.define("Checkgit.view.scheduleconfiguration.tree.ScheduleConfigTreeController", {
	...
	onItemClick : function(view, record, item, index, e) {
		if (index > 0) {
			...
			if (!isPresent) {
				var component = Ext.create("Checkgit.view.scheduleconfiguration.panel.ScheduleConfig", {
