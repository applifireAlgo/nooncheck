Ext.define('Checkgit.view.usermanagement.roles.AddNewRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Checkgit.view.usermanagement.roles.AddNewRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
