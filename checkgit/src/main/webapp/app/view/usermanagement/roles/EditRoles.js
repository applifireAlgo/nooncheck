Ext.define('Checkgit.view.usermanagement.roles.EditRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Checkgit.view.usermanagement.roles.EditRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
