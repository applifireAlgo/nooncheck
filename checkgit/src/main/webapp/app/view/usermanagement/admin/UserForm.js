Ext.define('Checkgit.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Checkgit.view.usermanagement.admin.AddUserDetailsViewModel', 'Checkgit.model.AddUserDataModel' ],
