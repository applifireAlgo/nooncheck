Ext.define('Checkgit.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Checkgit.view.usermanagement.enduser.UserProfileController', 'Checkgit.view.usermanagement.admin.AddUserDetailsViewModel', 'Checkgit.model.AddUserDataModel' ],
