package checkgit.app.shared.appbasicsetup.usermanagement;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<checkgit.app.shared.appbasicsetup.usermanagement.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            checkgit.app.shared.appbasicsetup.usermanagement.User other = (checkgit.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
