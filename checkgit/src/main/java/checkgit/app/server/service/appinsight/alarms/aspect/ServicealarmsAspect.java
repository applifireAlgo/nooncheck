package checkgit.app.server.service.appinsight.alarms.aspect;
...
public class ServicealarmsAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.service.appinsight.alarms..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
