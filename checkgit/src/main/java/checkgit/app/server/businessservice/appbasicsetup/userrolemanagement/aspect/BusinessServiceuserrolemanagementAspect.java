package checkgit.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
