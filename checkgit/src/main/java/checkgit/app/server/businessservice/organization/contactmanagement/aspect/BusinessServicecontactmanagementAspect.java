package checkgit.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.businessservice.organization.contactmanagement..*(..))")
