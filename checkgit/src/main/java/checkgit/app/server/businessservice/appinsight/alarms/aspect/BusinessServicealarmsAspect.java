package checkgit.app.server.businessservice.appinsight.alarms.aspect;
import checkgit.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
