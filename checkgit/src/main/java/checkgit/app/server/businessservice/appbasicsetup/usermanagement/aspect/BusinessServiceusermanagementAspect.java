package checkgit.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
