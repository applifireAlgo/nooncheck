package checkgit.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.businessservice.organization.locationmanagement..*(..))")
