package checkgit.app.server.repository.appbasicsetup.usermanagement.aspect;
...
public class RepositoryusermanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appbasicsetup.usermanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
