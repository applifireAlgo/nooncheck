package checkgit.app.server.repository.appinsight.alarms.aspect;
...
public class RepositoryalarmsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..find*(..)) && ! alarmRepofindOperation()")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..get*(..)) && ! alarmRepofindOperation()")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation() && ! alarmRepofindOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.appinsight.alarms.ArtLogAlarmRepository..getVersionNumber(..)) || execution(* checkgit.app.server.repository.appinsight.alarms.ArtLogAlarmRepository..getAlarmDataByType(..))")
