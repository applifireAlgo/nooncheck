...
public class StateRepositoryImpl extends SearchInterfaceImpl implements StateRepository<State> {
    ...
    public List<State> findAll() throws Exception {
        ...
        java.util.List<checkgit.app.shared.organization.locationmanagement.State> query = emanager.createQuery("select u from State u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<State> save(List<State> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.organization.locationmanagement.State obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.organization.locationmanagement.State s = emanager.find(checkgit.app.shared.organization.locationmanagement.State.class, id);
        emanager.remove(s);
    ...
    public List<State> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<checkgit.app.shared.organization.locationmanagement.State> listOfState = query.getResultList();
    ...
    public State findById(String stateId) throws Exception {
        ...
        checkgit.app.shared.organization.locationmanagement.State listOfState = (checkgit.app.shared.organization.locationmanagement.State) query.getSingleResult();
