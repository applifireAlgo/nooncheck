...
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws Exception {
        ...
        java.util.List<checkgit.app.shared.organization.locationmanagement.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Country> save(List<Country> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.organization.locationmanagement.Country obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.organization.locationmanagement.Country s = emanager.find(checkgit.app.shared.organization.locationmanagement.Country.class, id);
        emanager.remove(s);
    ...
    public Country findById(String countryId) throws Exception {
        ...
        checkgit.app.shared.organization.locationmanagement.Country listOfCountry = (checkgit.app.shared.organization.locationmanagement.Country) query.getSingleResult();
