...
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.appbasicsetup.usermanagement.PasswordAlgo obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.appbasicsetup.usermanagement.PasswordAlgo s = emanager.find(checkgit.app.shared.appbasicsetup.usermanagement.PasswordAlgo.class, id);
        emanager.remove(s);
    ...
    public PasswordAlgo findById(String algoId) throws Exception {
        ...
        checkgit.app.shared.appbasicsetup.usermanagement.PasswordAlgo listOfPasswordAlgo = (checkgit.app.shared.appbasicsetup.usermanagement.PasswordAlgo) query.getSingleResult();
