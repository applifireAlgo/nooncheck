...
public class UserAccessLevelRepositoryImpl extends SearchInterfaceImpl implements UserAccessLevelRepository<UserAccessLevel> {
    ...
    public List<UserAccessLevel> findAll() throws Exception {
        ...
        java.util.List<checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel> query = emanager.createQuery("select u from UserAccessLevel u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserAccessLevel> save(List<UserAccessLevel> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel s = emanager.find(checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel.class, id);
        emanager.remove(s);
    ...
    public UserAccessLevel findById(String userAccessLevelId) throws Exception {
        ...
        checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel listOfUserAccessLevel = (checkgit.app.shared.appbasicsetup.usermanagement.UserAccessLevel) query.getSingleResult();
