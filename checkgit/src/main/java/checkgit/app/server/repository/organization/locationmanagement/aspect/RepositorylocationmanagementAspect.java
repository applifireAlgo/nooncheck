package checkgit.app.server.repository.organization.locationmanagement.aspect;
...
public class RepositorylocationmanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkgit.app.server.repository.organization.locationmanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
