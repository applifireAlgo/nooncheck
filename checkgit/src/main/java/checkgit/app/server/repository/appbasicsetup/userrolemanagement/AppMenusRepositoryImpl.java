...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws Exception {
        ...
        java.util.List<checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus s = emanager.find(checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus.class, id);
        emanager.remove(s);
    ...
    public AppMenus findById(String menuId) throws Exception {
        ...
        checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus listOfAppMenus = (checkgit.app.shared.appbasicsetup.userrolemanagement.AppMenus) query.getSingleResult();
