...
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public List<UserRoleBridge> findAll() throws Exception {
        ...
        java.util.List<checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> query = emanager.createQuery("select u from UserRoleBridge u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<UserRoleBridge> save(List<UserRoleBridge> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge s = emanager.find(checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge.class, id);
        emanager.remove(s);
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception {
        ...
        java.util.List<checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
    ...
    public UserRoleBridge findById(String roleUserMapId) throws Exception {
        ...
        checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge listOfUserRoleBridge = (checkgit.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge) query.getSingleResult();
