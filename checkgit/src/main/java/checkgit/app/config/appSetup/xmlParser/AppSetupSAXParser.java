package checkgit.app.config.appSetup.xmlParser;
import checkgit.app.config.appSetup.model.AppConfiguration;

import checkgit.app.config.appSetup.model.AuthPlugin;

import checkgit.app.config.appSetup.model.AuthenticationConfig;

import checkgit.app.config.appSetup.model.ConnectionConfig;

import checkgit.app.config.appSetup.model.ConnectionPooling;

import checkgit.app.config.appSetup.model.ConnectorConfig;

import checkgit.app.config.appSetup.model.DatabaseConfig;

import checkgit.app.config.appSetup.model.DriveProperties;

import checkgit.app.config.appSetup.model.MailConfig;

import checkgit.app.config.appSetup.model.PathConfig;

import checkgit.app.config.appSetup.model.SchedulerConfig;

import checkgit.app.config.appSetup.model.SearchEngineConfig;
