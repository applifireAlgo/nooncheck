...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("NdHA2mWwYt9VMQUXigXwEIsIhS3aVCSNI6PXF7M25IsFQvuTuH");
        question.setQuestionIcon("4iy6MFPHzhD7L7ZBkiiBvSKwCp4KBbi9Ys2Xy4ndWKMdNXxc44");
        question.setLevelid(1);
        question.setQuestionDetails("D9nGKRoP6a");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("7y40lMTGZ4BesVAEAzhbSQ2a6ufvg00xr5d2Lwi5eS7M533ejg");
            question.setQuestionIcon("isV28lQYrOWT2Ak6hIblBHtimxvflC3Rw156GLHYJOsBuw2sBa");
            question.setLevelid(1);
            question.setVersionId(1);
            question.setQuestionDetails("jnFzZ1IzVs");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "aDn0CWi9HGeSsCvuOvUIxVvtQUkyfiscKdWzCncgY8amtxmJOPvKGhphOa6ruK260"));
