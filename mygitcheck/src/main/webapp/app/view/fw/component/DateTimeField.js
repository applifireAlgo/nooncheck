 ...
 */
Ext.define('Mygitcheck.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Mygitcheck.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Mygitcheck.view.fw.component.DateTimePicker(o);
    },
