Ext.define('Mygitcheck.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Mygitcheck.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Mygitcheck.view.console.ConsoleWindow');
