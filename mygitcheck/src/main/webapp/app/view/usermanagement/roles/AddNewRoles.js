Ext.define('Mygitcheck.view.usermanagement.roles.AddNewRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mygitcheck.view.usermanagement.roles.AddNewRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
