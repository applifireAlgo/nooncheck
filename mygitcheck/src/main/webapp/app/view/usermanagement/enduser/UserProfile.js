Ext.define('Mygitcheck.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Mygitcheck.view.usermanagement.enduser.UserProfileController', 'Mygitcheck.view.usermanagement.admin.AddUserDetailsViewModel', 'Mygitcheck.model.AddUserDataModel' ],
