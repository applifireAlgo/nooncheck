Ext.define('Mygitcheck.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mygitcheck.view.usermanagement.admin.AddUserDetailsViewModel', 'Mygitcheck.model.AddUserDataModel' ],
