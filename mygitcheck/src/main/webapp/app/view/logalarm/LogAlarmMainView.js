 ...
 * 
 */
Ext.define('Mygitcheck.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Mygitcheck.view.logalarm.LogAlarmMainViewController',
			'Mygitcheck.view.logalarm.tree.LogAlarmTreePanel',
			'Mygitcheck.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
