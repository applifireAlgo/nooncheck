 ...
 * 
 */
Ext.define('Mygitcheck.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mygitcheck.view.logalarm.mainscreen.AddLogAlarmController',
			'Mygitcheck.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mygitcheck.view.logalarm.mainscreen.AppAlarmPanel',
