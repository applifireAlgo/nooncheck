 ...
 * 
 */
Ext.define('Mygitcheck.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.logAlarmMainViewTabPanelController',
	
	init : function()
	{
		var component = Ext.create("Mygitcheck.view.logalarm.mainscreen.AddLogAlarm", {
			title : "",
		});
