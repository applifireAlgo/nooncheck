 ...
 * 
 */
Ext.define('Mygitcheck.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mygitcheck.view.securityconfig.SecurityConfigController',
			'Mygitcheck.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
