Ext.define('Mygitcheck.view.desktop.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Mygitcheck.view.desktop.design.drawer.main.MainPanelController','Mygitcheck.view.desktop.design.drawer.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
