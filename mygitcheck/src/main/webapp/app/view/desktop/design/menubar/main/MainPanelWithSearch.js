Ext.define('Mygitcheck.view.desktop.design.menubar.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Mygitcheck.view.desktop.design.menubar.main.MainPanelController','Mygitcheck.view.desktop.design.menubar.menu.AppMenuBar'],
    userinfo:{},
    id:'mainPanel',
