Ext.define('Mygitcheck.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Mygitcheck.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Mygitcheck.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Mygitcheck.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Mygitcheck.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Mygitcheck.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Mygitcheck.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Mygitcheck.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
