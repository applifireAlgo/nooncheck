 ...
 * 
 */
Ext.define("Mygitcheck.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mygitcheck.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
