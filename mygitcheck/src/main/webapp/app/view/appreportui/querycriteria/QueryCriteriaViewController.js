Ext.define('Mygitcheck.view.appreportui.querycriteria.QueryCriteriaViewController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.queryCriteriaController',
	requires : ['Mygitcheck.view.fw.DateRange','Mygitcheck.view.fw.DropDownRange'],
