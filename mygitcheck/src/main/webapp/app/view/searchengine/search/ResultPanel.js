Ext
		.define(
				'Mygitcheck.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mygitcheck.view.searchengine.search.SearchEngineMainPanelController','Mygitcheck.view.searchengine.search.PanelHeaderField' ,'Mygitcheck.view.searchengine.search.ReportGridView','Mygitcheck.view.searchengine.search.ReportChartView','Mygitcheck.view.searchengine.search.documentView','Mygitcheck.view.searchengine.search.DouMeanView','Mygitcheck.view.googlemaps.map.MapPanel'],
