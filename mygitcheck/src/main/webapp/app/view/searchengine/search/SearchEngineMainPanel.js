Ext.define('Mygitcheck.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Mygitcheck.view.searchengine.search.NorthPanel', 'Mygitcheck.view.searchengine.search.SearchResult','Mygitcheck.view.searchengine.search.SearchEngineMainPanelController'],
