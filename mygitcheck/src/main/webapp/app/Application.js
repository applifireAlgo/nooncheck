 ...
 */
Ext.define('Mygitcheck.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Mygitcheck.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Mygitcheck.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Mygitcheck.view.login.SessionLogin').center();
