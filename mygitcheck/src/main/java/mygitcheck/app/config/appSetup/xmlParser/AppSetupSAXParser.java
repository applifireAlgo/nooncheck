package mygitcheck.app.config.appSetup.xmlParser;
import mygitcheck.app.config.appSetup.model.AppConfiguration;

import mygitcheck.app.config.appSetup.model.AuthPlugin;

import mygitcheck.app.config.appSetup.model.AuthenticationConfig;

import mygitcheck.app.config.appSetup.model.ConnectionConfig;

import mygitcheck.app.config.appSetup.model.ConnectionPooling;

import mygitcheck.app.config.appSetup.model.ConnectorConfig;

import mygitcheck.app.config.appSetup.model.DatabaseConfig;

import mygitcheck.app.config.appSetup.model.DriveProperties;

import mygitcheck.app.config.appSetup.model.MailConfig;

import mygitcheck.app.config.appSetup.model.PathConfig;

import mygitcheck.app.config.appSetup.model.SchedulerConfig;

import mygitcheck.app.config.appSetup.model.SearchEngineConfig;
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		case "AppConfig":
			this.appConfiguration = new AppConfiguration(pathConfig, authenticationConfig, databaseConfig, searchEngineConfig, driveProperties, mailConfig,
					schedulerConfig, connectionConfigList,listOfJpaProperties);
			break;
		default:
			break;
		}
