...
import mygitcheck.app.config.appSetup.xmlParser.AppXMLLoader;
...
public class WebInitializer implements WebApplicationInitializer {
    ...
    public String getSolrHome() {
        return "/home/applifire/workspace/P2LALSSVSVQ7EP48A0IZDQ/mygitcheckSolr-4.9.0";
    }

    public String getPackage() {
        return "mygitcheck.app";
    }
}
