...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("QGcwTXBPLyS5njBDEJFBcyi1V7H1x2QQbiMLxhu9kaf1CLmjHW");
        question.setQuestionIcon("9N5rupPr8WbjiosqSrMmvSZ5a8uM2qStBffgaPrw7KiOa6mwhi");
        question.setQuestionDetails("GrG0DDnUq3");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("wDlT750WeM7sdx8Kpmz8lKLlmT5GQLrWL8Ga9bUIy3CMf3Yv5F");
            question.setQuestionIcon("2xiGXPsWJeYSTNPpCnewt9z8pYefWE8gsri4NnukA8bz26gd5o");
            question.setQuestionDetails("pIVuywt1hM");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ceowCwMbxkxgNICFuxrPA6mUqRbT9UYZpUkNXEUuOZpQMJPmpc4fcHWxMDf8aY2aV"));
