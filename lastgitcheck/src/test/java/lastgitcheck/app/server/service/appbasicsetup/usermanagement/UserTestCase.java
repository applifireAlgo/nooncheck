...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("viWSG7Zq5aQe42ok6P78UpO9tCCoFW1DSAoLw6BqqkqKy4sfC9");
        useraccessdomain.setDomainName("fwgsSdbVCUKDYuVNeWoquC95OTlZz6ZdsDEpssApkhjSoIoZnv");
        useraccessdomain.setDomainHelp("AECdnLz0dl7LO9dc4tfceoVfIbIO8yjlx8cafYj3MdVxoxZz5p");
        useraccessdomain.setDomainIcon("XKdM6N3TCiB5MQaZcD00EuQcKLOA4Ma56Zkp1o6m11goW01WwT");
        ...
        useraccesslevel.setLevelHelp("iheNHnKyhIGUahp4eDAlBtP34yAFiGcTtlUaK7l1bIzOKc96Sk");
        useraccesslevel.setLevelDescription("DIpkbEbyJVJKa3XyFXeZsMnIS1glC0mNGowYiVJUIcCcdQnhQX");
        useraccesslevel.setLevelName("gR0cN1cSfQ4pAqYLJuaUe8AhUdMs43lxNUM5JDxsy6Rw49Zu5q");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("eVk63C4nqzK0dClRRRAuTwuyUrEJgh0Bwef8VSGXYhzagJoVmE");
        ...
        User user = new User();
        user.setPasswordExpiryDate(new java.sql.Timestamp(1464157726117l));
        user.setIsLocked(1);
        user.setIsDeleted(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessCode(33290);
        user.setPasswordAlgo("989IT8SVBQu7XanvjN0UpZYec9n414Rj7GlhogoQvjQeNRhXoT");
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1464157726182l));
        user.setSessionTimeout(449);
        ...
        question.setQuestion("DhiLHwF9kKv2Eom7GDYus06Y0rN3hOUy4624GdcvWCEsyz38wt");
        question.setQuestionIcon("67N2t6LzfUZ95Qizr5MA4Ro8n4jTtOscTcOExJmvKZaZEw9xDj");
        question.setQuestionDetails("PqKKWsiA8f");
        ...
        passrecovery.setAnswer("WxIbdddzTA8HqhaadEDeKXdXDpAGpDTuLVBSgPtjFTmrhOstrG");
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464157726447l));
        userdata.setLast5Passwords("NKChh4ksSnuk2NjLp0XhbBOWUGDNhsWKN8i0gCU5CN5yoAagA9");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464157726458l));
        userdata.setLast5Passwords("MWDka5a8sEqiBo0kONNluNDSOAALgShFyHVpYQbjEP3aZHhmbt");
        userdata.setUser(user);
        userdata.setOneTimePassword("OI8vRnp7vr4kDg7EaXIYBoCcQDfvDGnR");
        userdata.setPassword("LkhH4qM1FRsUIgS4R6XNF7plOY9EDDrw3vhCfBVBCQMqOMb8ui");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 86615));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "c5nyt9KfZhs8bzqkzUhmm8olVvi99Tc8wgXSRE2tk9QcQ6xMYRuvuv4UTFuNDiSdu"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 3715));
