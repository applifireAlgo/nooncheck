 ...
 */
Ext.define('Lastgitcheck.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Lastgitcheck.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Lastgitcheck.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Lastgitcheck.view.login.SessionLogin').center();
