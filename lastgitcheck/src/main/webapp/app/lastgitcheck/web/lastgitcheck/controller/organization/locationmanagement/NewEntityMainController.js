Ext.define('Lastgitcheck.lastgitcheck.web.lastgitcheck.controller.organization.locationmanagement.NewEntityMainController', {
     extend: 'Lastgitcheck.view.fw.frameworkController.FrameworkViewController',
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#NewEntityForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#NewEntityForm');
          var grid = this.view.down('#NewEntityGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#NewEntityForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#NewEntityForm').down('#' + me.column.dataIndex + '').store;
