 ...
 */
Ext.define('Lastgitcheck.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Lastgitcheck.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Lastgitcheck.view.fw.component.DateTimePicker(o);
    },
