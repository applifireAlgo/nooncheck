 ...
 * 
 */
Ext.define('Lastgitcheck.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Lastgitcheck.view.logger.tabs.fileconnector.FileConnectorTabController'],
