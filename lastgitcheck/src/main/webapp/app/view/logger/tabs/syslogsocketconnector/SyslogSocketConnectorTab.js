 ...
 * 
 */
Ext.define('Lastgitcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Lastgitcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
