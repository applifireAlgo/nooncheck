...
Ext
		.define(
				'Lastgitcheck.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Lastgitcheck.view.logger.tabs.details.DetailsTab',
							'Lastgitcheck.view.logger.tabs.fileconnector.FileConnectorTab',
							'Lastgitcheck.view.logger.tabs.dbconnector.DBConnectorTab',
							'Lastgitcheck.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Lastgitcheck.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Lastgitcheck.view.logger.LogConfigurationTabPanelController',
