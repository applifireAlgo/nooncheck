Ext.define('Lastgitcheck.view.usermanagement.roles.AddNewRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Lastgitcheck.view.usermanagement.roles.AddNewRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
