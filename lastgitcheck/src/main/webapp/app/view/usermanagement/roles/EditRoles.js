Ext.define('Lastgitcheck.view.usermanagement.roles.EditRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Lastgitcheck.view.usermanagement.roles.EditRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
