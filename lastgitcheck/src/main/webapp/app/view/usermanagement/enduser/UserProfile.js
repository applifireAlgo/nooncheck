Ext.define('Lastgitcheck.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Lastgitcheck.view.usermanagement.enduser.UserProfileController', 'Lastgitcheck.view.usermanagement.admin.AddUserDetailsViewModel', 'Lastgitcheck.model.AddUserDataModel' ],
