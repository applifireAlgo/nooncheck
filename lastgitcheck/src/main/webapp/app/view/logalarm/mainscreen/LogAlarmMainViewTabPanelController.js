 ...
 * 
 */
Ext.define('Lastgitcheck.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.logAlarmMainViewTabPanelController',
	
	init : function()
	{
		var component = Ext.create("Lastgitcheck.view.logalarm.mainscreen.AddLogAlarm", {
			title : "",
		});
