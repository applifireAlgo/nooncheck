 ...
 * 
 */
Ext.define('Lastgitcheck.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Lastgitcheck.view.logalarm.mainscreen.AddLogAlarmController',
			'Lastgitcheck.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Lastgitcheck.view.logalarm.mainscreen.AppAlarmPanel',
