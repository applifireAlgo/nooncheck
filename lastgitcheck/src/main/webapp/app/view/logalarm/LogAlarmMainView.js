 ...
 * 
 */
Ext.define('Lastgitcheck.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Lastgitcheck.view.logalarm.LogAlarmMainViewController',
			'Lastgitcheck.view.logalarm.tree.LogAlarmTreePanel',
			'Lastgitcheck.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
