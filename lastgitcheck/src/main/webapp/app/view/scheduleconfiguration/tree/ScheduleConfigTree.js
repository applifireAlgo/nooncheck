 ...
 * 
 */
Ext.define("Lastgitcheck.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Lastgitcheck.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
