 ...
 * 
 */
Ext.define('Lastgitcheck.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Lastgitcheck.view.securityconfig.SecurityConfigController',
			'Lastgitcheck.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
