Ext
		.define(
				'Lastgitcheck.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Lastgitcheck.view.searchengine.search.documentController',
							'Lastgitcheck.view.searchengine.search.RowExpander' ],
