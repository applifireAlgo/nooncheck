Ext
		.define(
				'Lastgitcheck.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Lastgitcheck.view.searchengine.search.SearchEngineMainPanelController','Lastgitcheck.view.searchengine.search.PanelHeaderField' ,'Lastgitcheck.view.searchengine.search.ReportGridView','Lastgitcheck.view.searchengine.search.ReportChartView','Lastgitcheck.view.searchengine.search.documentView','Lastgitcheck.view.searchengine.search.DouMeanView','Lastgitcheck.view.googlemaps.map.MapPanel'],
