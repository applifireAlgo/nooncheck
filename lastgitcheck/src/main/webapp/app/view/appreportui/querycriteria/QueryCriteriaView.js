Ext.define('Lastgitcheck.view.appreportui.querycriteria.QueryCriteriaView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Lastgitcheck.view.appreportui.querycriteria.QueryCriteriaViewController' ],
