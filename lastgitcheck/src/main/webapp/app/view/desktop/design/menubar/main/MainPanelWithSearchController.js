Ext.define('Lastgitcheck.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Lastgitcheck.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Lastgitcheck.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Lastgitcheck.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Lastgitcheck.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Lastgitcheck.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Lastgitcheck.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Lastgitcheck.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
