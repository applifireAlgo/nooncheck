Ext.define('Lastgitcheck.view.desktop.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Lastgitcheck.view.desktop.design.drawer.main.MainPanelController','Lastgitcheck.view.desktop.design.drawer.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
