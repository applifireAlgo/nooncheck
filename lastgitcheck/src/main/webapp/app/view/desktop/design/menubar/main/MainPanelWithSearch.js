Ext.define('Lastgitcheck.view.desktop.design.menubar.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Lastgitcheck.view.desktop.design.menubar.main.MainPanelController','Lastgitcheck.view.desktop.design.menubar.menu.AppMenuBar'],
    userinfo:{},
    id:'mainPanel',
