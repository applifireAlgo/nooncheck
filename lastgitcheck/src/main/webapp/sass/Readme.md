...
folder are mapped to the application's root namespace, 'Lastgitcheck'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Lastgitcheck"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Lastgitcheck' in the same way
as `"Lastgitcheck/sass/src"`.
