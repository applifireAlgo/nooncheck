...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.organization.contactmanagement.CommunicationData other = (lastgitcheck.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
