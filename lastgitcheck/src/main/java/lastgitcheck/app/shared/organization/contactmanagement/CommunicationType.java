...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.organization.contactmanagement.CommunicationType other = (lastgitcheck.app.shared.organization.contactmanagement.CommunicationType) obj;
            if (commType == null) {
                return false;
