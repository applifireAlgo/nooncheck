package lastgitcheck.app.shared.organization.contactmanagement;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<lastgitcheck.app.shared.organization.locationmanagement.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<lastgitcheck.app.shared.organization.contactmanagement.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.organization.contactmanagement.CoreContacts other = (lastgitcheck.app.shared.organization.contactmanagement.CoreContacts) obj;
            if (contactId == null) {
                return false;
