package lastgitcheck.app.shared.appbasicsetup.userrolemanagement;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<lastgitcheck.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.appbasicsetup.userrolemanagement.Roles other = (lastgitcheck.app.shared.appbasicsetup.userrolemanagement.Roles) obj;
            if (roleId == null) {
                return false;
