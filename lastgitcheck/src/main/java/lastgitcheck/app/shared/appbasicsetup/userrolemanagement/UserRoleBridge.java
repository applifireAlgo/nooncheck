...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge other = (lastgitcheck.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
