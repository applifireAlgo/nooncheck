...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            lastgitcheck.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge other = (lastgitcheck.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
