package lastgitcheck.app.server.businessservice.appbasicsetup.usermanagement.aspect;
...
public class BusinessServiceusermanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.businessservice.appbasicsetup.usermanagement..*(..))")
