package lastgitcheck.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.businessservice.organization.locationmanagement..*(..))")
