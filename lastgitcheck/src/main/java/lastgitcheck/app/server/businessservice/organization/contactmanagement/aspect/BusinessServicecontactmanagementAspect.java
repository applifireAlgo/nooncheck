package lastgitcheck.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.businessservice.organization.contactmanagement..*(..))")
