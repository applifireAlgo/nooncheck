package lastgitcheck.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
