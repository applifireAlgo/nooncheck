package lastgitcheck.app.server.businessservice.appinsight.alarms.aspect;
import lastgitcheck.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
