package lastgitcheck.app.server.service.appbasicsetup.userrolemanagement.aspect;
...
public class ServiceuserrolemanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.userrolemanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
