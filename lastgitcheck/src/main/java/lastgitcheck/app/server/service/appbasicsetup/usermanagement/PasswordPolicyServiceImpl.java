...
public class PasswordPolicyServiceImpl extends PasswordPolicyService {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        ...
        lastgitcheck.app.shared.appbasicsetup.usermanagement.PasswordPolicy lstpasswordpolicy = passwordPolicyrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
