package lastgitcheck.app.server.service.appbasicsetup.aaa.aspect;
import lastgitcheck.app.server.service.aspect.ServiceAspect;
...
public class ServiceaaaAspect extends ServiceAspect {
    ...
    public Object aroundAdvice2Save(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), methodCallDetails.getExecution_Time());
        } catch (Exception e) {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.service.appbasicsetup.aaa..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
