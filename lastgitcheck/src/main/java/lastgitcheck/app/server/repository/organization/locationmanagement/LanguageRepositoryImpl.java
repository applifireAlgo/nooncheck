...
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.locationmanagement.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Language> save(List<Language> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            lastgitcheck.app.shared.organization.locationmanagement.Language obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        lastgitcheck.app.shared.organization.locationmanagement.Language s = emanager.find(lastgitcheck.app.shared.organization.locationmanagement.Language.class, id);
        emanager.remove(s);
    ...
    public Language findById(String languageId) throws Exception {
        ...
        lastgitcheck.app.shared.organization.locationmanagement.Language listOfLanguage = (lastgitcheck.app.shared.organization.locationmanagement.Language) query.getSingleResult();
