...
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.contactmanagement.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<ContactType> save(List<ContactType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            lastgitcheck.app.shared.organization.contactmanagement.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        lastgitcheck.app.shared.organization.contactmanagement.ContactType s = emanager.find(lastgitcheck.app.shared.organization.contactmanagement.ContactType.class, id);
        emanager.remove(s);
    ...
    public ContactType findById(String contactTypeId) throws Exception {
        ...
        lastgitcheck.app.shared.organization.contactmanagement.ContactType listOfContactType = (lastgitcheck.app.shared.organization.contactmanagement.ContactType) query.getSingleResult();
