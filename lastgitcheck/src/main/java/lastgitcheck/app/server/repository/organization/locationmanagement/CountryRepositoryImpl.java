...
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.locationmanagement.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Country> save(List<Country> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            lastgitcheck.app.shared.organization.locationmanagement.Country obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        lastgitcheck.app.shared.organization.locationmanagement.Country s = emanager.find(lastgitcheck.app.shared.organization.locationmanagement.Country.class, id);
        emanager.remove(s);
    ...
    public Country findById(String countryId) throws Exception {
        ...
        lastgitcheck.app.shared.organization.locationmanagement.Country listOfCountry = (lastgitcheck.app.shared.organization.locationmanagement.Country) query.getSingleResult();
