...
public class GenderRepositoryImpl extends SearchInterfaceImpl implements GenderRepository<Gender> {
    ...
    public List<Gender> findAll() throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.contactmanagement.Gender> query = emanager.createQuery("select u from Gender u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Gender> save(List<Gender> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            lastgitcheck.app.shared.organization.contactmanagement.Gender obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        lastgitcheck.app.shared.organization.contactmanagement.Gender s = emanager.find(lastgitcheck.app.shared.organization.contactmanagement.Gender.class, id);
        emanager.remove(s);
    ...
    public Gender findById(String genderId) throws Exception {
        ...
        lastgitcheck.app.shared.organization.contactmanagement.Gender listOfGender = (lastgitcheck.app.shared.organization.contactmanagement.Gender) query.getSingleResult();
