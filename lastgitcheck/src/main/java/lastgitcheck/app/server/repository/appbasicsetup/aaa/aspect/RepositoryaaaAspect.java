package lastgitcheck.app.server.repository.appbasicsetup.aaa.aspect;
...
public class RepositoryaaaAspect extends RepositoryAspect {
    ...
    public Object aroundAllOtherOpeartion(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            Log.out.println("null", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName(), methodCallDetails.getExecution_Time());
        } catch (Exception e) {
    ...
    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* lastgitcheck.app.server.repository.appbasicsetup.aaa..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
