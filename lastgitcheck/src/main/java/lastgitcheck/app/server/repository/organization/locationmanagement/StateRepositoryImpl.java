...
public class StateRepositoryImpl extends SearchInterfaceImpl implements StateRepository<State> {
    ...
    public List<State> findAll() throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.locationmanagement.State> query = emanager.createQuery("select u from State u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<State> save(List<State> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            lastgitcheck.app.shared.organization.locationmanagement.State obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        lastgitcheck.app.shared.organization.locationmanagement.State s = emanager.find(lastgitcheck.app.shared.organization.locationmanagement.State.class, id);
        emanager.remove(s);
    ...
    public List<State> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<lastgitcheck.app.shared.organization.locationmanagement.State> listOfState = query.getResultList();
    ...
    public State findById(String stateId) throws Exception {
        ...
        lastgitcheck.app.shared.organization.locationmanagement.State listOfState = (lastgitcheck.app.shared.organization.locationmanagement.State) query.getSingleResult();
